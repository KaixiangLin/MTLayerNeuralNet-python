...
class myFLAGS:
    ...
    def __init__(self):
        ...
        self.batch_size = 100
        self.max_iteration = 30 # int(self.data_size * self.num_epoch / self.batch_size)
        self.record_persteps = 100  # every x steps records the models
